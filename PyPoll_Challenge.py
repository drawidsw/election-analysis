...
# Swapna: This file is in the top folder, so I removed the first argument to the function below.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        # Swapna: It is unnecessary to check both count and percent. One implies the other.
